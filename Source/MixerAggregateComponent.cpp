...
void MixerAggregateComponent::paint (juce::Graphics& g)
{
    ...
    */
    ...
    g.setFont (14.0f);
    g.drawText ("MixerAggregateComponent", getLocalBounds(),
                juce::Justification::centred, true);   // draw some placeholder text
}

void MixerAggregateComponent::resized()
{
